...
- (void)zhh_addActionHandler:(void(^)(UIButton * sender))touchHandler{
    [self zhh_addActionHandler:touchHandler forControlEvents:UIControlEventTouchUpInside];
}
/// 添加事件
- (void)zhh_addActionHandler:(void(^)(UIButton * sender))touchHandler forControlEvents:(UIControlEvents)controlEvents{
