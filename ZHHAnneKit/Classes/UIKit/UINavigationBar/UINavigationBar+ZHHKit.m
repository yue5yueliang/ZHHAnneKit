...
@interface ZHHCustomNavigationView : UIView
...
@property (nonatomic, strong) ZHHCustomNavigationView *customNavigationView;
@property (nonatomic, strong) UIImage *backClearImage, *lineClearImage;
@end

@implementation UINavigationBar (ZHHKit)
...
/// 隐藏线条
- (void)zhh_hiddenLine:(BOOL)hidden{
...
- (instancetype)zhh_customNavgationBackImage:(UIImage *_Nullable)image background:(UIColor *_Nullable)color{
    ...
    if (self.customNavigationView == nil) {
        ...
        self.customNavigationView = [[ZHHCustomNavigationView alloc]initWithFrame:barBounds];
        [self zhh_customNavgationHiddenBottomLine:self.hiddenBottomLine];
    }
    if (color) {
...
- (instancetype)zhh_customNavgationHeight:(CGFloat)height{
    ...
    [self clearSystemNavigation];
    if (self.customNavigationView == nil) {
        self.customNavigationView = [[ZHHCustomNavigationView alloc]init];
        [self zhh_customNavgationHiddenBottomLine:self.hiddenBottomLine];
    }
...
- (ZHHCustomNavigationView *)customNavigationView{
    return objc_getAssociatedObject(self, _cmd);
}
- (void)setCustomNavigationView:(ZHHCustomNavigationView *)customNavigationView{
...
@interface ZHHCustomNavigationView()
@property (nonatomic, strong) UIImageView *backImageView;
@property (nonatomic, strong) UIView *bottomLine;
@end

@implementation ZHHCustomNavigationView
