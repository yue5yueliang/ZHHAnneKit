...
@implementation NSString (ZHHMIME)
/**
...
- (NSString *)zhh_MIMEType {
    return [[self class] zhh_MIMETypeForExtension:[self pathExtension]];
}

+ (NSString *)zhh_MIMETypeForExtension:(NSString *)extension {
    return [[self zhh_MIMEDict] valueForKey:[extension lowercaseString]];
}
/**
 *  @brief  常见MIME集合
 *
