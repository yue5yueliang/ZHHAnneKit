...
@implementation NSString (ZHHVerify)
/// 是否为纯字母
- (BOOL)isPureLetter{
...
- (NSString *)zhh_removeSpecialCharacter:(NSString*_Nullable)character{
    ...
    if (urgentRange.location != NSNotFound){
        return [self zhh_removeSpecialCharacter:[self stringByReplacingCharactersInRange:urgentRange withString:@""]];
    }
    return self;
}
